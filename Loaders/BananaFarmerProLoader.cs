...
public class BananaFarmerProLoader : ModByteLoader<Il2CppAssets.Scripts.Models.Towers.TowerModel> {
	...
	protected override string BytesFileName => "BananaFarmerPros.bytes";
	...
	private void Set_v_BananaFarmerCamoBananasModel_Fields(int start, int count) {
		Set_v_TowerBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.BananaFarmerCamoBananasModel)m[i+start];
			v.camoBananaWeaponModel = (Il2CppAssets.Scripts.Models.Towers.Weapons.WeaponModel) m[br.ReadInt32()];
			v.camoBananaFarmCount = br.ReadInt32();
		}
	}
	...
	private void Set_v_MonkeyBankerModel_Fields(int start, int count) {
		Set_v_TowerBehaviorBuffModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.MonkeyBankerModel)m[i+start];
			v.bankIncomeMultiplierBase = br.ReadSingle();
			v.bankIncomeMultiplierPerStack = br.ReadSingle();
			v.bankIncomeMaxStacks = br.ReadInt32();
			v.isBananaFinancier = br.ReadBoolean();
			v.bankInstaDepositAmount = br.ReadSingle();
			v.bankInstaDepositStackAmount = br.ReadSingle();
			v.bankInstaDepositMaxStackAmount = br.ReadSingle();
			v.bankCollectAnimation = br.ReadInt32();
		}
	}
	...
	private void Set_v_BananaFarmerRegrowBananasModel_Fields(int start, int count) {
		Set_v_TowerBehaviorBuffModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.BananaFarmerRegrowBananasModel)m[i+start];
			v.regrowBananaSkinModel = (Il2CppAssets.Scripts.Models.Towers.Projectiles.ProjectileModel) m[br.ReadInt32()];
			v.regrowPerBanana = br.ReadInt32();
			...
			v.confirmSound = (Il2CppAssets.Scripts.Models.Audio.SoundModel) m[br.ReadInt32()];
			...
			v.isBananaIntelligenceBureau = br.ReadBoolean();
		}
	}
	...
	private void Set_v_BananaFarmerRegrowBananasWeaponBehaviorModel_Fields(int start, int count) {
		Set_v_WeaponBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.BananaFarmerRegrowBananasWeaponBehaviorModel)m[i+start];
			v.regrowBananaPeelModel = (Il2CppAssets.Scripts.Models.Towers.Projectiles.ProjectileModel) m[br.ReadInt32()];
			v.regrowPerBanana = br.ReadInt32();
		}
	}
	...
	private void Set_v_ClearHitBloonsWhenNoLongerCollidingModel_Fields(int start, int count) {
		Set_v_ProjectileBehaviorModel_Fields(start, count);
		var t = Il2CppType.Of<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.ClearHitBloonsWhenNoLongerCollidingModel>();
		var intervalField = t.GetField("interval", bindFlags);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.ClearHitBloonsWhenNoLongerCollidingModel)m[i+start];
	...
	private void Set_v_BananaPeelLimitProjectileModel_Fields(int start, int count) {
		Set_v_WeaponBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.BananaPeelLimitProjectileModel)m[i+start];
			v.projectileId = br.ReadBoolean() ? null : br.ReadString();
			v.bananasRequired = br.ReadInt32();
		}
	}
	...
	protected override Il2CppAssets.Scripts.Models.Towers.TowerModel Load(byte[] bytes) {
		using (var s = new MemoryStream(bytes)) {
			using (var reader = new BinaryReader(s)) {
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Behaviors.BananaFarmerCamoBananasModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.ClearHitBloonsWhenNoLongerCollidingModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.BananaPeelLimitProjectileModel>();
				...
				Set_v_BananaFarmerCamoBananasModel_Fields(br.ReadInt32(), br.ReadInt32());
				...
				Set_v_ClearHitBloonsWhenNoLongerCollidingModel_Fields(br.ReadInt32(), br.ReadInt32());
				Set_v_RemoveBloonModifiersModel_Fields(br.ReadInt32(), br.ReadInt32());
				Set_v_WindModel_Fields(br.ReadInt32(), br.ReadInt32());
				Set_v_BananaPeelLimitProjectileModel_Fields(br.ReadInt32(), br.ReadInt32());
