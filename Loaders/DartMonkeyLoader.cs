...
public class DartMonkeyLoader : ModByteLoader<Il2CppAssets.Scripts.Models.Towers.TowerModel> {
	...
	private void Set_v_MonkeyFanClubModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.immuneBloonProperties = (BloonProperties) (br.ReadInt32());
			v.display = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.towerDisplay = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.originDisplay = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.towerOriginDisplay = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.effectId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.effectLeaderId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.effectOnOtherId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
