...
public class DartlingGunnerLoader : ModByteLoader<Il2CppAssets.Scripts.Models.Towers.TowerModel> {
	...
	protected override string BytesFileName => "DartlingGunners.bytes";
	...
	private void Set_v_DartlingMaintainLastPosModel_Fields(int start, int count) {
		Set_v_TowerBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.DartlingMaintainLastPosModel)m[i+start];
		}
	}
	...
	private void Set_v_TravelStraightSlowdownModel_Fields(int start, int count) {
		...
		var t = Il2CppType.Of<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.TravelStraightSlowdownModel>();
		var slowdownSpeedField = t.GetField("slowdownSpeed", bindFlags);
		var minSpeedField = t.GetField("minSpeed", bindFlags);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.TravelStraightSlowdownModel)m[i+start];
	...
	private void Set_v_TargetPointerModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.Attack.Behaviors.TargetPointerModel)m[i+start];
	...
	private void Set_v_EjectAnimationModel_Fields(int start, int count) {
		Set_v_WeaponBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.EjectAnimationModel)m[i+start];
	...
	private void Set_v_TargetIndependantModel_Fields(int start, int count) {
		Set_v_TargetSupplierModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.Attack.Behaviors.TargetIndependantModel)m[i+start];
			v.isSelectable = br.ReadBoolean();
			v.targetProvider = (Il2CppAssets.Scripts.Models.Towers.Behaviors.Attack.Behaviors.TargetSupplierModel) m[br.ReadInt32()];
		}
	}
	...
	private void Set_v_RateBasedAnimationOffsetModel_Fields(int start, int count) {
		Set_v_WeaponBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.RateBasedAnimationOffsetModel)m[i+start];
	...
	private void Set_v_TravelCurvyModel_Fields(int start, int count) {
		Set_v_TravelStraitModel_Fields(start, count);
		var t = Il2CppType.Of<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.TravelCurvyModel>();
		var turnRateField = t.GetField("turnRate", bindFlags);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.TravelCurvyModel)m[i+start];
	...
	private void Set_v_LineEffectModel_Fields(int start, int count) {
		Set_v_WeaponBehaviorModel_Fields(start, count);
		var t = Il2CppType.Of<Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.LineEffectModel>();
		var displayLengthSpeedField = t.GetField("displayLengthSpeed", bindFlags);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.LineEffectModel)m[i+start];
			v.lineDisplayPath = (Il2CppAssets.Scripts.Models.Effects.AssetPathModel) m[br.ReadInt32()];
			v.lineDisplayLength = br.ReadSingle();
			v.effectAtEnd = (Il2CppAssets.Scripts.Models.Effects.EffectModel) m[br.ReadInt32()];
			v.effectAtStart = (Il2CppAssets.Scripts.Models.Effects.EffectModel) m[br.ReadInt32()];
			v.isLineDisplayEndless = br.ReadBoolean();
			v.useDisplayLengthSpeed = br.ReadBoolean();
			displayLengthSpeedField.SetValue(v,br.ReadSingle().ToIl2Cpp());
	...
	protected override Il2CppAssets.Scripts.Models.Towers.TowerModel Load(byte[] bytes) {
		using (var s = new MemoryStream(bytes)) {
			using (var reader = new BinaryReader(s)) {
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Behaviors.DartlingMaintainLastPosModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.TravelStraightSlowdownModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Behaviors.Attack.Behaviors.TargetPointerModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.CreateProjectileOnBlockerCollideModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.EjectAnimationModel>();
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Behaviors.Attack.Behaviors.TargetIndependantModel>();
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Behaviors.Attack.Behaviors.TargetFirstModel>();
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.RateBasedAnimationOffsetModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.TravelCurvyModel>();
				...
				Create_Records<Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.LineEffectModel>();
