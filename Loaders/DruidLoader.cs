...
public class DruidLoader : ModByteLoader<Il2CppAssets.Scripts.Models.Towers.TowerModel> {
	...
	private void Read_a_PrefabReference_Array() {
		...
		for (var i = 0; i < count; i++) {
			...
			for (var j = 0; j < arr.Length; j++) {
				arr[j] = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			}
			m[mIndex++] = arr;
		}
	}
	...
	private void Set_v_JungleVineEffectModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.displayFrontAssetId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.displayBackAssetId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.fullscreen = br.ReadBoolean();
	...
	private void Set_v_DruidVengeanceEffectModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.defaultProjectilePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.weakProjectilePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.mediumProjectilePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.epicProjectilePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
	...
	private void Set_v_CashPerBananaFarmInRangeModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.textAssetId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
	...
	private void Set_v_SpiritOfTheForestModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.objectToPlace1FarPath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace2FarPath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace3FarPath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace4FarPath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectsToPlaceFarPath = (Il2CppAssets.Scripts.Utils.PrefabReference[]) m[br.ReadInt32()];
			v.objectToPlace1MiddlePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace2MiddlePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace3MiddlePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace4MiddlePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectsToPlaceMiddlePath = (Il2CppAssets.Scripts.Utils.PrefabReference[]) m[br.ReadInt32()];
			v.objectToPlace1ClosePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace2ClosePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace3ClosePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.objectToPlace4ClosePath = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
