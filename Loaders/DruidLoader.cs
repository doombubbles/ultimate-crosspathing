...
public class DruidLoader : ModByteLoader<Il2CppAssets.Scripts.Models.Towers.TowerModel> {
	...
	private void Set_v_OffsetModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.OffsetModel)m[i+start];
			v.range = br.ReadSingle();
	...
	private void Set_v_LifeBasedAttackSpeedModel_Fields(int start, int count) {
		Set_v_WeaponBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.LifeBasedAttackSpeedModel)m[i+start];
	...
	private void Set_v_JungleVineEffectModel_Fields(int start, int count) {
		Set_v_ProjectileBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.JungleVineEffectModel)m[i+start];
			...
			v.sound3 = (Il2CppAssets.Scripts.Models.Audio.SoundModel) m[br.ReadInt32()];
			v.sound4 = (Il2CppAssets.Scripts.Models.Audio.SoundModel) m[br.ReadInt32()];
			v.ageingDestroyModel = (Il2CppAssets.Scripts.Models.Behaviors.AgeingDestroyModel) m[br.ReadInt32()];
			v.backEffectDisplayModel = (Il2CppAssets.Scripts.Models.GenericBehaviors.DisplayModel) m[br.ReadInt32()];
			v.bloonEffectDisplayModel = (Il2CppAssets.Scripts.Models.GenericBehaviors.DisplayModel) m[br.ReadInt32()];
			v.frontEffectDisplayModel = (Il2CppAssets.Scripts.Models.GenericBehaviors.DisplayModel) m[br.ReadInt32()];
		}
	}
	...
	private void Set_v_AgeingDestroyModel_Fields(int start, int count) {
		Set_v_Model_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Behaviors.AgeingDestroyModel)m[i+start];
	...
	private void Set_v_JungleVineLimitProjectileModel_Fields(int start, int count) {
		Set_v_WeaponBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Weapons.Behaviors.JungleVineLimitProjectileModel)m[i+start];
	...
	private void Set_v_PoplustSupportModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.PoplustSupportModel)m[i+start];
	...
	private void Set_v_DruidVengeanceEffectModel_Fields(int start, int count) {
		Set_v_TowerBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.DruidVengeanceEffectModel)m[i+start];
			v.damageModifierWrathModel = (Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.DamageModifierWrathModel) m[br.ReadInt32()];
			v.smallGlowEffectModel = (Il2CppAssets.Scripts.Models.Effects.EffectModel) m[br.ReadInt32()];
			v.mediumGlowEffectModel = (Il2CppAssets.Scripts.Models.Effects.EffectModel) m[br.ReadInt32()];
			v.epicGlowEffectModel = (Il2CppAssets.Scripts.Models.Effects.EffectModel) m[br.ReadInt32()];
	...
	private void Set_v_DamageModifierWrathModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.DamageModifierWrathModel)m[i+start];
	...
	private void Set_v_SpiritOfTheForestModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.SpiritOfTheForestModel)m[i+start];
	...
	private void Set_v_DamageOverTimeZoneModel_Fields(int start, int count) {
		Set_v_TowerBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Behaviors.DamageOverTimeZoneModel)m[i+start];
			v.behaviorModel = (Il2CppAssets.Scripts.Models.Bloons.Behaviors.DamageOverTimeModel) m[br.ReadInt32()];
			v.range = br.ReadSingle();
	...
	private void Set_v_DamageOverTimeCustomModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Bloons.Behaviors.DamageOverTimeCustomModel)m[i+start];
	...
	private void Set_v_IgnoreInsufficientPierceModel_Fields(int start, int count) {
		Set_v_ProjectileBehaviorModel_Fields(start, count);
		for (var i=0; i<count; i++) {
			var v = (Il2CppAssets.Scripts.Models.Towers.Projectiles.Behaviors.IgnoreInsufficientPierceModel)m[i+start];
		}
	}
	...
	protected override Il2CppAssets.Scripts.Models.Towers.TowerModel Load(byte[] bytes) {
		using (var s = new MemoryStream(bytes)) {
			using (var reader = new BinaryReader(s)) {
				...
				Create_Records<Il2CppAssets.Scripts.Models.Behaviors.AgeingDestroyModel>();
