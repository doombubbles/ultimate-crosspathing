...
public class HeliPilotLoader : ModByteLoader<Il2CppAssets.Scripts.Models.Towers.TowerModel> {
	...
	private void Set_v_PatrolPointsSettingModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.display = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.lineDisplay = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
	...
	private void Set_v_RedeployModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.isSelectableGameObject = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
