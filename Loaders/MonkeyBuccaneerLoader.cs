...
public class MonkeyBuccaneerLoader : ModByteLoader<Il2CppAssets.Scripts.Models.Towers.TowerModel> {
	...
	private void Set_v_MoabTakedownModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.displayAtEjectId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
		}
	}
	...
	private void Set_v_CreateRopeEffectModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.assetId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
			v.endAssetId = new Il2CppAssets.Scripts.Utils.PrefabReference(br.ReadString());
	...
	private void Set_v_AddMakeshiftAreaModel_Fields(int start, int count) {
		...
		for (var i=0; i<count; i++) {
			...
			v.points = (Il2CppAssets.Scripts.Simulation.SMath.Vector3[]) m[br.ReadInt32()];
