...
public class NinjaMonkeyLoader : ModByteLoader<Assets.Scripts.Models.Towers.TowerModel> {
	...
	private void Set_v_ActivateRangeSupportZoneModel_Fields(int start, int count) {
		...
		var t = Il2CppType.Of<Assets.Scripts.Models.Towers.Behaviors.Abilities.Behaviors.ActivateRangeSupportZoneModel>();
		var lifespanField = t.GetField("lifespan", bindFlags);
		for (var i=0; i<count; i++) {
	...
	private void Set_v_ActivateDamageModifierSupportZoneModel_Fields(int start, int count) {
		Set_v_AbilityBehaviorBuffModel_Fields(start, count);
		var t = Il2CppType.Of<Assets.Scripts.Models.Towers.Behaviors.Abilities.Behaviors.ActivateDamageModifierSupportZoneModel>();
		var lifespanField = t.GetField("lifespan", bindFlags);
		for (var i=0; i<count; i++) {
