...
public class TackShooterLoader : ModByteLoader<Assets.Scripts.Models.Towers.TowerModel> {
	...
	private void Set_v_SpinModel_Fields(int start, int count) {
		...
		var t = Il2CppType.Of<Assets.Scripts.Models.Towers.Weapons.Behaviors.SpinModel>();
